...
def main():
    ...
    # load files
    try:
        gt = np.loadtxt('/home/yunfan/work_spaces/master_thesis/rpg_trajectory_evaluation/results/cmp_tracking/desktop/dvspanotracking/desktop_dvspanotracking_boxes_rotation/stamped_groundtruth.txt')
        gt_t = gt[:, 0]
