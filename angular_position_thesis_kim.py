...
def main():
    ...
    try:
        gt = np.loadtxt(
            '/home/yunfan/work_space/master_thesis/rpg_trajectory_evaluation/results/cmp_tracking/desktop/dvspanotracking/desktop_dvspanotracking_fast_motion/stamped_groundtruth.txt')
        gt_t = gt[:, 0]
        ...
        glo = np.loadtxt(
            '/home/yunfan/work_space/master_thesis/rpg_trajectory_evaluation/results/cmp_tracking/desktop/globallyaligned/desktop_globallyaligned_fast_motion/stamped_traj_estimate.txt')
        glo_t = glo[:, 0]
        glo_vec = R.from_quat(glo[:, 4:8]).as_rotvec()

        mos = np.loadtxt(
            '/home/yunfan/work_space/master_thesis/rpg_trajectory_evaluation/results/cmp_tracking/desktop/mosaic/desktop_mosaic_fast_motion/stamped_traj_estimate.txt')
        mos_t = mos[:, 0]
